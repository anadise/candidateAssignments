...
import Modal, { ModalHandlers, ModalProps } from "./Modal";

type NewClientFormProps = {
  modalRef?: React.MutableRefObject<ModalHandlers | null>;
  onSubmit?: (value: Record<string, any>) => Promise<void> | void;
};

export default function NewClientForm({ modalRef, onSubmit }: NewClientFormProps) {
  return (
    <Modal ref={modalRef}>
      <Formik
        initialValues={{}}
